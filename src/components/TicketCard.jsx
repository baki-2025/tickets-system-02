    ...
    <div className="lg-rounded p-4 shadow  bg-[url('/img/vector2.png')] bg-cover bg-center  ">
      <div className="bg-yellow-50 grid grid-cols-1 md:grid-cols-2 gap-2">
        ...
        <div className="flex flex-col gap-4 ">
          <h3 className="font-extrabold  text-black ">{ticket.title}</h3>
...
//   return (
//     <div className="rounded-lg p-4 shadow bg-[url('/img/vector2.png')] bg-cover bg-center">
//       <div className="bg-yellow-50 grid grid-cols-1 md:grid-cols-2 gap-2">
        
//         {/* Title spanning first column */}
